...
def fast_food_receipt(order):
        ...
        #calculates discount. Every combo reduces the total cost by two. Number of combos is calculated by the minimum value of a, b and c.
...
if __name__ == '__main__':
        ...
        print("The total bill is:",fast_food_receipt(order))
